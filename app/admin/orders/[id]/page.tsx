        ...
        <div id="invoice" className="space-y-6">
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-2 text-sm">
              ...
              <div className="flex justify-between"><span className="text-muted-foreground">Diskon</span><span className="text-emerald-600 dark:text-emerald-400">-{formatIDR(order.discount)}</span></div>
